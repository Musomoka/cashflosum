...
class EntryTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entry_type" do
    assert_difference('EntryType.count') do
      post entry_types_url, params: { entry_type: { default_acc: @entry_type.default_acc, fixed_entry_type: @entry_type.fixed_entry_type, name: @entry_type.name } }
    end
  ...
  test "should update entry_type" do
    patch entry_type_url(@entry_type), params: { entry_type: { default_acc: @entry_type.default_acc, fixed_entry_type: @entry_type.fixed_entry_type, name: @entry_type.name } }
